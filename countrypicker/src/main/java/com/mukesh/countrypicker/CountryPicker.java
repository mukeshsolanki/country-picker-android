...
public class CountryPicker
  ...
  private com.mukesh.countrypicker.CountryPickerListener countryPickerListener;
  ...
  public void showDialog(FragmentManager supportFragmentManager,
    ...
    if (countries == null || countries.isEmpty()) {
      ...
      CountryPickerDialog countryPickerDialog = CountryPickerDialog.newInstance(this);
      countryPickerDialog.setListener(countryPickerListener);
  ...
  public static class Builder {
    ...
    public Builder listener(com.mukesh.countrypicker.CountryPickerListener countryPickerListener) {
    ...
    public CountryPicker build() {
      if (context == null) {
        throw new IllegalStateException("Context is need!");
      }
