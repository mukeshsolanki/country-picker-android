...
public class CountryListAdapter extends BaseAdapter {
    ...
    public CountryListAdapter(Context context, List<Country> countries, int direction) {
        super();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            //the current API version does not support changing direction
            //TODO remove when upgrade the version > 17
            if (direction == LayoutDirection.RTL) {
                view = inflater.inflate(R.layout.row_rtl, null);
            } else {
